...
class NameDialog(context: Context, nameInterface: StatFragment) : Dialog(context) {

    // 액티비티에서 인터페이스를 받아옴
    private var nameDialogInterface: StatFragment = nameInterface
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        okButton.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                // 메모를 추가해줌
                nameDialogInterface.onOkButtonClicked(content)
                dismiss()
            }
        }
